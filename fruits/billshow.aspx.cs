...
namespace fruits
{
    public partial class WebForm18 : System.Web.UI.Page
    {
        ...
        private void findorderdate(String Orderid)
        {
            ...
            //  SqlConnection con = new SqlConnection("Data Source=10.112.60.43;Initial Catalog=Student;User ID=student;Password=student");
            string shivu = "Data Source=10.112.60.43;Initial Catalog=Student;User ID=student;Password=student";
            String myquery = "Select * from amulorderdetails where orderid='" + Orderid + "'";
            SqlConnection con = new SqlConnection(shivu);
        ...
        private void showgrid(String orderid)
        {
            ...
            // SqlConnection con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["shivu"].ToString());
            // String mycon = "Data Source=HP-PC\\SQLEXPRESS;Initial Catalog=ShoppingData;Integrated Security=True";
            SqlConnection scon = new SqlConnection(shivu);
            String myquery = "select * from amulorderdetails where orderid='" + orderid + "'";
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = myquery;
            cmd.Connection = con;
